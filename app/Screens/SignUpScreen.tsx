...
import { Image, SafeAreaView, Text, TextInput, ActivityIndicator, Platform, View, Alert, StyleSheet, TouchableOpacity } from 'react-native';
...
const SignUpScreen = ({ navigation }: any) => {
    ...
    const createUser = async () => {
        ...
        formdata.append("device_token", (Math.floor(Math.random() * 10000) + 10000).toString().substring(1));
        ...
        var res = await fetch("https://client.appmania.co.in/Swoop/api/signUp", requestOptions).then(async (res) => await res.json())
